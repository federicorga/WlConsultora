...
function MarcaPatente() {
    ...
    const textos = [
        ...
        'Actualmente la gestión del registro de marcas y patentes demora aproximadamente dos años y tiene una vigencia de diez años. ',
    ...
    return (
      <>
        <Gestion titulo={"Registro de Marcas y patente"} textoServicio={textos}/>
      </>
    );
}
