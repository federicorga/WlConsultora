...
function LocacionInmobiliaria() {
    ...
    const textos = [
      'Uno de los primero contratos que una PYME celebrara será uno de locación, esto es, uno de alquiler cuyo objeto recaerá sobre un inmueble comercial en donde desarrollara u ofertara sus productos o servicios. ',
'Los contrato de locación, a su vez, será uno de los primeros que el órgano habilitante requerirá del emprendedor a la hora de abrir su comercio, ya sea en la ciudad autónoma de buenos aires o en la provincia. ',
