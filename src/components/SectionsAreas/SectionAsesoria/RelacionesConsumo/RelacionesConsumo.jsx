...
function RelacionesConsumo() {
  const textos = [
    'Una de las relaciones más predominantes dentro del derecho comercial y el ejercicio del emprender son las relaciones de consumo, las cuales constituyen el vínculo jurídico entre un proveedor de cosas o servicios y un consumidor o usuario.',
