...
function ContratosAdhesion() {
  const textos = [
    ...
    'A su vez la Ley de Defensa del Consumidor establece expresamente que la interpretación de los contratos de consumo de interpretaran a favor del consumidor y la posibilidad de demandar la nulidad del contrato o de una clausula especifica cuando se pruebe que la empresa omitió su deber de buena fe en las relaciones comerciales de consumo.',
  ];
  return (
    <>
