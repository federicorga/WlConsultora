...
function IcoMercadoLibre({width="64",height="64"}) {
  return (
    ...
    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M43.4 22.683a23.998 23.998 0 0 0-8.547 2.692m-2.273 2.081c.989 1.037-.926 3.273-2.149 2.05s-2.581-2.513-2.581-2.513"/>
    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.135 29.215c.988 1.037-.927 3.273-2.15 2.05s-2.025-1.962-2.025-1.962"/>
    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24.202 31.316a2.309 2.309 0 0 0 3.648-.186"/>
    ...
    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M4.67 22.279a18.308 18.308 0 0 1 9.064 3.214"/>
    </svg>
  );
}
