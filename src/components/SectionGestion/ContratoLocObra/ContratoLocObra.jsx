...
'Lo que toda PYME debe saber de este este tipo de contrato es el concepto de la subcontratación, en donde un emprendedor principal puede desarrollar el rol de ser locatario con relación a otros actores denominados “subcontratistas” vinculados contractualmente con éste, en cuyo caso estos subcontratistas no podrán entablar acción con tras el dueños de la obra. ',
'Estos tipos de contrato presentan varios sistemas de fijación de precios a establecerse de antemano entre las partes, como por ejemplo el sistema de “ajuste alzado” en donde es el contratistas quien provee los materiales a ser utilizados para la obra, o por “unidad de medida” en donde la obra se pacta por “piezas” debiendo designar previamente la cantidad total de las misma para incurrir en inconvenientes a futuro. También tenemos el sistema por “coste y costas” en donde la retribución se determina sobre el valor de los materiales, de la mano de obras y de otros gastos directos e indirectos.',
'Por último, el emprendedor debe conocer la totalidad de las obligaciones y responsabilidades que competen a la figura del contratista, las cuales deben necesariamente estar plasmadas en los contratos eficientes de locación de obras.'
